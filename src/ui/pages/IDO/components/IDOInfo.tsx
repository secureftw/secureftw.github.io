...
const IDOInfo = ({
  ...
  return (
    <div className="box is-shadowless">
      ...
      <div className="level">
        <div className="level-left">
          <div className="level-item is-block">
            <p className="has-text-weight-bold heading">Mainnet at</p>
	          <small>
		          {moment.unix(LAUNCH_AT).utc().format("llll")} UTC
	          </small>
          </div>
        </div>
      ...
      {!isSwapActive && (
        <button onClick={onClick} className="button is-primary is-fullwidth">
          Swap
        </button>
      )}

      {/*<p className="has-text-weight-medium heading mb-2">Swap rates</p>*/}
