...
function utilsString() {
  const hex2strResult = utilsHex2strInputEle.value ? neo3Dapi.utils.hex2str(utilsHex2strInputEle.value) : '';
  const str2hexResult = utilsStr2hexInputEle.value ? neo3Dapi.utils.str2hex(utilsStr2hexInputEle.value) : '';
...
function utilsInteger() {
  const hex2intResult = utilsHex2intInputEle.value ? neo3Dapi.utils.hex2int(utilsHex2intInputEle.value) : '';
  const int2hexResult = utilsInt2hexInputEle.value ? neo3Dapi.utils.int2hex(utilsInt2hexInputEle.value) : '';
...
function utilsReverseHex() {
  const reversehexResult = utilsReverseHexInputEle.value ? neo3Dapi.utils.reverseHex(utilsReverseHexInputEle.value) : '';
